  ...
  <body>
    <form name=survey_form method=post>
      <table border=0 cellspacing=0 cellpadding=0 width='200' align='center'>
        ...
        <td align=middle><a><img src="../img/b_vote.gif" border="0" style='cursor:hand' onclick=update()></a>
          <a><img src="../img/b_result.gif" border="0" style="cursor:hand" onclick=result()></a>
